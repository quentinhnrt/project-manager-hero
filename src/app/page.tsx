...
export default function Home() {
  ...
  return (
    <main className="min-h-screen gap-2 lg:gap-0 p-0 lg:p-4 flex flex-col items-center lg:justify-between">
      <AlertDialog>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Bienvenue sur notre jeu de tri de ticket ou le but est de trier
              les tickets en fonction de leur catégorie. Afin d'avoir le
              meilleur score possible. Un système de multiplicateur est en place
      ...
      <ScoreBoard />
      <div className="grid grid-rows-3 gap-2 overflow-hidden items-center w-full bg-slate-100 p-2 lg:p-4 rounded-lg lg:max-h-none lg:overflow-auto lg:grid-cols-4 lg:grid-rows-4 lg:gap-4 ">
