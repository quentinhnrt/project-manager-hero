...
export default function Home() {
    ...
    const {isHardMode, setIsHardMode} = useSettingsContext()
    ...
    return (
        <main className="min-h-screen gap-2 lg:gap-0 p-0 lg:p-4 flex flex-col items-center lg:justify-between">
            <ScoreBoard/>
            <div
                className="grid grid-rows-3 gap-2 max-h-[360px] overflow-hidden items-center w-full bg-slate-100 p-2 lg:p-4 rounded-lg lg:max-h-none lg:overflow-auto lg:grid-cols-4 lg:grid-rows-4 lg:gap-4 ">
            ...
            <div
                className="gap-1 px-2 md:px-0 grid grid-rows-2 grid-cols-2 lg:grid-cols-4 lg:grid-rows-1 lg:gap-4 w-full lg:min-h-72">
