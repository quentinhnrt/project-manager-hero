...
export default function Home() {
  ...
  return (
    <main className="min-h-screen gap-2 lg:gap-0 p-0 lg:p-4 flex flex-col items-center lg:justify-between">
      ...
      <div className="grid grid-rows-3 gap-2 max-h-[360px] overflow-hidden items-center w-full bg-slate-100 p-4 rounded-lg lg:max-h-none lg:overflow-auto lg:grid-cols-4 lg:grid-rows-4 lg:gap-4 ">
